...
from keras.optimizers import Adam as Adam_k, SGD as SGD_k
from tensorflow.python.keras.optimizers import Adam as Adam_tf # not possible to use
...
def get_weights_and_preds():
    ...
    opt = Adam_k(lr=0.001) # this will fail the test (on my current pc)
